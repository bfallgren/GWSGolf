...
<html lang="en">
    ...
    <style>
        ...
        <div class="container mt-2">    
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <input type="text" name="golfer" id="golfer" class="form-control" placeholder="Golfer" />
                </div>
                <div class="col-md-3">
    ...
    <script>
        $(document).ready(function(){
            ...
            function load_data(from_date = '', to_date = '', golfer = '')
            {
                $('#order_table').DataTable({
                    ...
                    ajax: {
                        url:'{{ route("allscores") }}',
                        data:{from_date:from_date, to_date:to_date, golfer:golfer}
                    },
                    columns: [
            ...
            $('#filter').click(function(){
                ...
                var golfer = $('#golfer').val();
                if(from_date != '' &&  to_date != '')
                {
                    $('#order_table').DataTable().destroy();
                    load_data(from_date, to_date, golfer);
                }
                else
                {
